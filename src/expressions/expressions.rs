...
// the block will be assigned to the place expression such as a local variable. However, if the
// last expression of the block ends with a semicolon, the return value will be ().
