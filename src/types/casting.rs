// Rust provides no implicit type conversion (coercion) between primitive types. But, the explicit type
...
// has undefined behavior. The behavior of all casts between integral types is well defined in Rust
